...
public class Common {
	...
	public static void serverScoreboardTeamJoin(EntityPlayer player, String teamColor)
	{
		try
		{
	...
	public static void serverScoreboardClear()
	{
		try
		{
			MinecraftServer.getServer().executeCommand("scoreboard teams empty blue");
			MinecraftServer.getServer().executeCommand("scoreboard teams empty orange");
		}
		catch(Exception e)
		{
			e.printStackTrace();
