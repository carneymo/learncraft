...
@Mod(modid = "MC_LearnCraft", name = "LearnCraft", version = "1.1.4")
...
public class Common
{
    ...
    public void load(FMLInitializationEvent event)
    {
        ...
        teamDefenseOrange = (TeamDefenseBlockOrange) new TeamDefenseBlockOrange(TeamDefenseOrangeID, Material.ground).setUnlocalizedName("teamDefenseOrange");
        ...
        teamDefenseBlue = (TeamDefenseBlockBlue) new TeamDefenseBlockBlue(TeamDefenseBlueID, Material.ground).setUnlocalizedName("teamDefenseBlue");
        ...
        blockDesignateBlue = new BlockTeamDesignateBlue(520, Material.iron).setUnlocalizedName("blockDesignateBlue");
        ...
        blockDesignateOrange = new BlockTeamDesignateOrange(519, Material.iron).setUnlocalizedName("blockDesignateOrange");
    ...
    public void serverStart(FMLServerStartingEvent event)
    {
        ...
        server = MinecraftServer.getServer(); //Gets current server
        ...
        server.executeCommand("gamerule weather clear 10800");
    }
    ...
    {
        if (teleportOn == false && override == false)
        {
            player.addChatMessage("Teleport is currently off.");
        }
        else if (teleportOn == true || override == true)
        {
            ...
            if (side == Side.SERVER)
            {
                Common.coordinates.TeleportPlayer((EntityPlayerMP) player, loc);
            }
        }
        else
        {
    ...
    public static void serverScoreboardClear()
    {
        try
        {
            server.executeCommand("scoreboard teams empty blue");
            server.executeCommand("scoreboard teams empty orange");
        }
        catch (Exception e)
        {
            e.printStackTrace();
